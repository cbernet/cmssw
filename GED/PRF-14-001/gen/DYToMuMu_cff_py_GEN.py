...
# with command line options: DYToMuMu_cff.py -s GEN --eventcontent=AODSIM -n 10 --no_exec --conditions=run2_design
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DYToMuMu_cff.py nevts:10'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('DYToMuMu_cff_py_GEN.root'),
