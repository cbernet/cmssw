...
# with command line options: step4 --datatier AOD --process reRECO --conditions auto:run2_data --filtername RECOfromRECO -s RECO,EI --eventcontent AOD --no_exec -n 100 --filein file:step3.root --fileout file:step4.root --data
