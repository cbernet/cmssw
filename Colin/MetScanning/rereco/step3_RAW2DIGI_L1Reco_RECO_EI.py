...
# with command line options: step3 --datatier GEN-SIM-RECO --conditions auto:run1_mc -s RAW2DIGI,L1Reco,RECO,EI --eventcontent RECOSIM -no_exec -n 100 --filein file:step2.root --fileout file:step3.root
...
process.GlobalTag.globaltag = '75X_dataRun2_v6'
