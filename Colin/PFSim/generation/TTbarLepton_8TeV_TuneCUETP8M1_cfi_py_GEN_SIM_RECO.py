...
# with command line options: TTbarLepton_8TeV_TuneCUETP8M1_cfi.py --fast -s GEN,SIM,RECO --pileup=NoPileUp --eventcontent=AODSIM -n 10 --no_exec --conditions auto:run2_mc_FULL --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('TTbarLepton_8TeV_TuneCUETP8M1_cfi.py nevts:10'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TTbarLepton_8TeV_TuneCUETP8M1_cfi_py_GEN_SIM_RECO.root'),
